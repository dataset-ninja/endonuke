...
def convert_and_upload_supervisely_project(api, workspace_id):
    ...
    tag_meta_ptg2 = sly.TagMeta("ptg2", sly.TagValueType.NONE)
    tag_meta_ptg3 = sly.TagMeta("ptg3", sly.TagValueType.NONE)
    tag_meta_stud1 = sly.TagMeta("stud1", sly.TagValueType.NONE)
    tag_meta_stud2 = sly.TagMeta("stud2", sly.TagValueType.NONE)
    tag_meta_stud3 = sly.TagMeta("stud3", sly.TagValueType.NONE)
    tag_meta_stud4 = sly.TagMeta("stud4", sly.TagValueType.NONE)
